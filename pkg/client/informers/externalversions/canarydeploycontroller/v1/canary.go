...
import (
	...
	versioned "k8s.io/canary-deploy-controller/pkg/client/clientset/versioned"
	internalinterfaces "k8s.io/canary-deploy-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s.io/canary-deploy-controller/pkg/client/listers/canarydeploycontroller/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.CanarydeploycontrollerV1().Canaries(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CanarydeploycontrollerV1().Canaries(namespace).Watch(options)
			},
		},
		&canarydeploycontroller_v1.Canary{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *canaryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&canarydeploycontroller_v1.Canary{}, f.defaultInformer)
}
